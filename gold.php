        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="card ml-5" style="width: 18rem;">
                    <img src="img/gold/1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">GOLD FISH Rp.50.000</h5>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star-half-alt"></i>
                        <p class="card-text">Merupakan keluarga dari ikan emas yang memiliki warna oren</p>
                        <a href="#" class="btn btn-primary btncart">Add Cart</a>
                    </div>
                </div>
                <div class="card ml-5" style="width: 18rem;">
                    <img src="img/gold/2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">GOLD FISH Rp.50.000</h5>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="card ml-5" style="width: 18rem;">
                    <img src="img/gold/3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">GOLD FISH Rp.50.000</h5>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="card ml-5" style="width: 18rem;">
                    <img src="img/gold/4.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">GOLD FISH Rp.50.000</h5>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="card ml-5" style="width: 18rem;">
                    <img src="img/gold/5.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">GOLD FISH Rp.50.000</h5>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="card ml-5" style="width: 18rem;">
                    <img src="img/gold/6.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">GOLD FISH Rp.50.000</h5>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
